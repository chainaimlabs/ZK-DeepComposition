import { bpmnCircuit } from './bpmnCircuit.js';
...
console.log('actual path4 trace', actualPath1, ' evaluation ', t1.toBoolean());
...
console.log('actual path4 trace', actualPath2, ' evaluation ', t2.toBoolean());
...
console.log('actual path4 trace', actualPath3, ' evaluation ', t3.toBoolean());
// ----------------------------------------------------
...
console.log('actual path4 trace', actualPath4, ' evaluation ', t4.toBoolean());
...
//# sourceMappingURL=bpmnBusinessProcessProver.js.map